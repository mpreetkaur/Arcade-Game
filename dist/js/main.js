...
var levelCounter = document.querySelector(".levels");
var leftLives = document.querySelector(".lives");
var bestLife = document.querySelector(".bestLevel");
var levels = 1;
var lives = 3;
...
var enemy1 = new Enemy(0, 225, 50);
var enemy2 = new Enemy(-50, 140, 70);
var enemy3 = new Enemy(-100, 60, 90);
var enemy4 = new Enemy(-800, 225, 50);
var enemy5 = new Enemy(-400, 140, 30);

var allEnemies = [enemy1, enemy2, enemy3, enemy4, enemy5];

var player = new Player(50, 50); // player postioned using x and y-axis
...
document.addEventListener('keyup', function (e) {
    ...
    var sAlert = document.querySelector(".swal-overlay--show-modal");
    if (!sAlert) {
